...
public class ControlCopy {
	private static final String CSH_NAME = "/home/vcausality/launch/csh11.spv";
	...
	public ControlCopy createPipeline() {
		try(var stack = stackPush()) {
	...
	public void drawControl(VkCommandBuffer c, int imageIdx) {
		try(var stack = stackPush()) {
