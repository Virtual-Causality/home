...
public class GuideCopy {
	private static final String CSH_NAME = "/home/vcausality/launch/csh12.spv";
	...
	public GuideCopy createPipeline() {
		try(var stack = stackPush()) {
	...
	public void drawGuide(VkCommandBuffer c, int imageIdx) {
		try(var stack = stackPush()){
